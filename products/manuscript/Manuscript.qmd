---
title: "Data Analysis Project - What are the trends in anti-microbial resistance among outbreak isolates over time, geography, and pathogen?"
author: "Elle Adams"
format:
  docx:
    toc: false
...
---
This uses [MS Word as output format](https://quarto.org/docs/output-formats/ms-word.html). 
...
* Elle Adams$^{1}$ (ORCID: 0000-0000-1234-5678) 
...
The datasets utilized in this project are from the  BEAM (Bacteria, Enterics, Ameba, and Mycotics) Dashboard, which include data from the System for Enteric Disease Response, Investigation, and Coordination (SEDRIC), National Antimicrobial Resistance Monitoring System for Enteric Bacteria (NARMS) and National Outbreak Reporting System (NORS). The datasets contain information about pathogens, serotypes, antimicrobial resistance, HHS region, burden, and trajectory. I will likely combine a couple datasets on the BEAM dashboard to answer my questions. 

## Questions/Hypotheses to be addressed

The question I am interested in asking for this project concerns investigating trends in anti-microbial resistance among outbreak isolates over time, geography, and pathogen. This question interests me primarily because I am interested in understanding the "rules" or lack thereof for outbreaks, particularly bacterial outbreaks. 

Before really looking at any of the data, I would hypothesize that outbreak strains would have very similar anti-microbial resistance mutations, and I would imagine that they would be geographically separated into serotypes. 

{{< pagebreak >}}

# Methods 

Part 1 - At this stage, I imagine for the analysis statistical analyses, linear regressions, plots over time, plots over different regions, plots separating isolates by classification and frequency, investigation of the types of antimicrobial resistance, etc. Pretty vague right now. 
